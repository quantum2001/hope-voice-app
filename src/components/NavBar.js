...
import { RiDashboardLine, RiHome8Fill, AiOutlineShoppingCart, IoWalletOutline, BiUser, FaShuttleVan, FaTicketAlt, FiSettings } from "react-icons/all"
    ...
    return (
        ...
        <nav>
            ...
            <div className='nav-link-list'>
                ...
                <Link to='/inventory' className={currentLocation.match('/inventory') ? 'nav-link active-nav-icon' : 'nav-link'}>
                    <RiHome8Fill className='nav-icon' />
                    <p>Inventory</p>
                </Link>
                <Link to='/customer' className={currentLocation.match('/customer') ? 'nav-link active-nav-icon' : 'nav-link'}>
